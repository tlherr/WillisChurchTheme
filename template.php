...
function nexus_menu_tree__main_menu($variables) {
  return '<ul id="main-menu" class="menu">' . $variables['tree'] . '</ul>';
}
...
function nexus_js_alter(&$javascript) {
...
if (drupal_is_front_page()) {
  drupal_add_js(drupal_get_path('theme', 'nexus') . '/js/vendor/bxslider/jquery.bxslider.js');
